...
Der Name wird von der App in Form eines frei wählbaren Benutzernamens benötigt, um die verschiedenen Nutzer der App zu Authentifizieren und zu Indentifizieren. Der angegebene Name ist für andere Nutzer der App öffentlich sichtbar, sobald der Nutzer einen Inhalt in der App veröffentlicht.
...
Verwendet werden die Daten, um sie erneut in der App abrufen zu können. Dies geschieht bei Fotos sowie Texten und dem Namen gegenüber allen anderen Nutzern der App. E-Mail Addressen werden nicht an Dritte weitergegeben. Außerdem werden die an die Datenbank übermittelten Daten zur Optimierung und Verbesserung der APP verwendet. JJG behält sich das Recht vor, die Daten zur ordentlichen Demonstration zu verwenden.


Wie kann ich meine Daten löschen?

Der Nutzer dieser App hat jederzeit die Möglichkeit die Löschung der von ihm gesammelten Daten einzufordern. Hierzu reicht eine E-Mail an den Betreiber. Die permanente Löschung des Profil eines Nutzers kann auch jederzeit innerhalb der App veranlasst werden. In diesem Fall werden alle personenbezogenen Daten, die in die App eingegeben wurden, permanent gelöscht.
...
5.2 Recht auf Berichtigung (Artikel 20 DSGVO)
...
5.8 Beschwerderecht bei Aufsichtsbehörde
